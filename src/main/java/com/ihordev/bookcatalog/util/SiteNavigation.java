...
/**
 * This class constructs navigation information for every view declared
 * in XML document that must be loaded and provided by user.
...
public class SiteNavigation {
	 ...
	 * 
	 * @return map the map that contains navigation paths for each view mapped by view name.
	 */
	...
	/**
	 * Searches for navigation paths for a view. If path has query
	 * parameters, this method tries to obtain them from view model.
	 * 
	 * @param viewName the view for which navigation paths are searched.
	 * @param viewModelMap a map that contains data for dynamic query parameters.
	 ...
	 * 
	 * @param 	doc normalized XML document that contains navigation information.
	 * @param 	pathMessageMappings a {@link org.springframework.context.MessageSource} that contains
	 * 			text content for path representation in the corresponding view.
	...
	private static void buildNavigations(Node node, 
										 List<NavigationPath> currentPaths, 
										 Map<String, List<NavigationPath>> viewNavigations,
										 MessageSource pathMessageMappings)
	{
	...
	/**
	 * Builds a new instance that has no data. This method is used when
	 * XML document cannot be provided.
	 * 
